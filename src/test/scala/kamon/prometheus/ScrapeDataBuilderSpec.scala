  ...
  "the scrape data builder formatter" should {
    "append units to the metric names when reporting values in the time dimension" in {
      ...
      builder()
        ...
        .build() should include {
          """
            |# TYPE service_counter_one_seconds_total counter
            |service_counter_one_seconds_total 10.0
            |# TYPE service_gauge_one_seconds gauge
            |service_gauge_one_seconds 20.0
          """.stripMargin.trim()
        }
    }
    ...
    "append units to the metric names when reporting values in the information dimension" in {
      ...
      builder()
        ...
        .build() should include {
          """
          |# TYPE service_counter_one_bytes_total counter
          |service_counter_one_bytes_total 10.0
          |# TYPE service_gauge_one_bytes gauge
          |service_gauge_one_bytes 20.0
        """.stripMargin.trim()
        }
    }
    ...
    "normalize tag names" in {
      ...
      builder()
        ...
        .build() should include {
          """
          |# TYPE service_counter_one_seconds_total counter
          |service_counter_one_seconds_total{tag_with_dots="value"} 10.0
          |# TYPE service_gauge_one_seconds gauge
          |service_gauge_one_seconds 20.0
        """.stripMargin.trim()
        }
    ...
    "append counters and group them together by metric name" in {
      ...
      builder().appendCounters(Seq(counterOne, counterTwo, counterOneWithTag)).build() should include {
        """
          |# TYPE service_counter_one_total counter
          |service_counter_one_total 10.0
          |service_counter_one_total{t="v"} 30.0
          |# TYPE service_counter_two_total counter
          |service_counter_two_total 20.0
        """.stripMargin.trim()
      }
    ...
    "append gauges and group them together by metric name" in {
      ...
      builder().appendGauges(Seq(gaugeOne, gaugeTwo, gaugeTwoWithTags)).build() should include {
        """
          |# TYPE service_gauge_one gauge
          |service_gauge_one 10.0
          |# TYPE service_gauge_two gauge
          |service_gauge_two 20.0
          |service_gauge_two{t="v",t2="v2"} 30.0
        """.stripMargin.trim()
      }
    }
    ...
    "override histogram buckets with custom configuration" in {
      ...
      builder(customBuckets = Map("histogram.custom-buckets" → Seq(1D, 2D, 4D))).appendHistograms(Seq(customBucketsHistogram)).build() should include {
        """
          ...
          |service_histogram_custom_buckets_bucket{quantile="1.0"} 1.0
          |service_histogram_custom_buckets_bucket{quantile="2.0"} 2.0
          |service_histogram_custom_buckets_bucket{quantile="4.0"} 4.0
          |service_histogram_custom_buckets_bucket{quantile="+Inf"} 10.0
    ...
    "append histograms grouped together by metric name and with all their derived time series " in {
      ...
      builder(buckets = Seq(15D)).appendHistograms(Seq(histogramOne)).build() should include {
        """
          ...
          |service_histogram_one_bucket{quantile="15.0"} 10.0
          |service_histogram_one_bucket{quantile="+Inf"} 10.0
      ...
      builder(buckets = Seq(5D, 10D, 15D, 20D)).appendHistograms(Seq(histogramTwo)).build() should include {
        """
          ...
          |service_histogram_two_bucket{quantile="5.0"} 5.0
          |service_histogram_two_bucket{quantile="10.0"} 10.0
          |service_histogram_two_bucket{quantile="15.0"} 15.0
          |service_histogram_two_bucket{quantile="20.0"} 20.0
          |service_histogram_two_bucket{quantile="+Inf"} 20.0
      ...
      builder(buckets = Seq(3D)).appendHistograms(Seq(histogramThree)).build() should include {
        """
          ...
          |service_histogram_three_bucket{quantile="3.0"} 0.0
          |service_histogram_three_bucket{quantile="+Inf"} 6.0
      ...
      builder(buckets = Seq(3D, 50D)).appendHistograms(Seq(histogramThree)).build() should include {
        """
          |# TYPE service_histogram_three histogram
          |service_histogram_three_bucket{quantile="3.0"} 0.0
          |service_histogram_three_bucket{quantile="50.0"} 6.0
          |service_histogram_three_bucket{quantile="+Inf"} 6.0
          |service_histogram_three_count 6.0
          |service_histogram_three_sum 45.0
        """.stripMargin.trim()
      ...
      builder(buckets = Seq(3D, 50D, 60D, 70D)).appendHistograms(Seq(histogramThree)).build() should include {
        """
          ...
          |service_histogram_three_bucket{quantile="3.0"} 0.0
          |service_histogram_three_bucket{quantile="50.0"} 6.0
          |service_histogram_three_bucket{quantile="60.0"} 6.0
          |service_histogram_three_bucket{quantile="70.0"} 6.0
          |service_histogram_three_bucket{quantile="+Inf"} 6.0
          |service_histogram_three_count 6.0
          |service_histogram_three_sum 45.0
        """.stripMargin.trim()
      ...
      builder(buckets = Seq(7D)).appendHistograms(Seq(histogramThree)).build() should include {
        """
          |# TYPE service_histogram_three histogram
          |service_histogram_three_bucket{quantile="7.0"} 3.0
          |service_histogram_three_bucket{quantile="+Inf"} 6.0
          |service_histogram_three_count 6.0
          |service_histogram_three_sum 45.0
        """.stripMargin.trim()
      ...
      builder(buckets = Seq(0.005D, 0.05D, 0.5D, 1D, 2D, 2.1D, 2.2D, 2.3D, 10D)).appendHistograms(Seq(histogramWithZero)).build() should include {
        """
          ...
          |service_histogram_with_zero_bucket{quantile="0.005"} 1.0
          |service_histogram_with_zero_bucket{quantile="0.05"} 1.0
          |service_histogram_with_zero_bucket{quantile="0.5"} 1.0
          |service_histogram_with_zero_bucket{quantile="1.0"} 2.0
          |service_histogram_with_zero_bucket{quantile="2.0"} 3.0
          |service_histogram_with_zero_bucket{quantile="2.1"} 3.0
          |service_histogram_with_zero_bucket{quantile="2.2"} 3.0
          |service_histogram_with_zero_bucket{quantile="2.3"} 3.0
          |service_histogram_with_zero_bucket{quantile="10.0"} 11.0
          |service_histogram_with_zero_bucket{quantile="+Inf"} 11.0
    ...
    "include global custom tags from the Kamon.environment.tags" in {
      ...
      builder(environmentTags = Map("env_key" → "env_value"))
        ...
        .build() should include {
          """
          |# TYPE service_counter_one_seconds_total counter
          |service_counter_one_seconds_total{tag_with_dots="value",env_key="env_value"} 10.0
          |# TYPE service_gauge_one_seconds gauge
          |service_gauge_one_seconds{env_key="env_value"} 20.0
        """.stripMargin.trim()
        }
    }
    ...
    "let environment tags have precedence over custom tags" in {
      ...
      builder(environmentTags = Map("custom.tag" → "environment-value"))
        ...
        .build() should include {
          """
          |# TYPE service_some_metric_seconds_total counter
          |service_some_metric_seconds_total{custom_tag="environment-value"} 10.0
          |# TYPE service_some_metric_seconds gauge
